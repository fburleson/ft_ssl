...
typedef char        byte_t;
typedef __uint128_t encrypted_byte_t;
...
typedef struct encrypted_array_s
{
...
encrypted_array_t init_encrypted_array(const size_t size);
void              free_byte_array(byte_array_t *const array);
void              free_encrypted_array(encrypted_array_t *const array);
